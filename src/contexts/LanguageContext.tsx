...
const translations: Translations = {
  ...
  'common.adminOnly': { en: 'Admin only', fr: 'Administrateurs uniquement' },
  'orgchartSync.tabLabel': { en: 'Orgchart Sync', fr: 'Synchro Organigramme' },
  'orgchartSync.title': { en: 'Orgchart Source of Truth', fr: 'Organigramme : source de vérité' },
  'orgchartSync.description': { en: 'Link xpandify ministries and people to their orgchart records, then sync changes from orgchart on demand.', fr: 'Liez les ministères et les personnes de xpandify à leurs fiches dans l\'organigramme, puis synchronisez les changements à la demande.' },
  'orgchartSync.backfillMinistries': { en: 'Backfill Ministries', fr: 'Lier les ministères' },
  'orgchartSync.backfillMinistriesDescription': { en: 'Match each unlinked ministry to its orgchart counterpart. Auto-matched rows are pre-checked.', fr: 'Associez chaque ministère non lié à sa fiche dans l\'organigramme. Les correspondances automatiques sont pré-cochées.' },
  'orgchartSync.backfillPeople': { en: 'Backfill People', fr: 'Lier les personnes' },
  'orgchartSync.backfillPeopleDescription': { en: 'Match each unlinked person to their orgchart record. Auto-matched rows are pre-checked.', fr: 'Associez chaque personne non liée à sa fiche dans l\'organigramme. Les correspondances automatiques sont pré-cochées.' },
  'orgchartSync.allMinistriesLinked': { en: 'All ministries are linked.', fr: 'Tous les ministères sont liés.' },
  'orgchartSync.allPeopleLinked': { en: 'All people are linked.', fr: 'Toutes les personnes sont liées.' },
  'orgchartSync.searchPeople': { en: 'Search people by name…', fr: 'Rechercher par nom…' },
  'orgchartSync.selectOrgchartMinistry': { en: 'Select orgchart ministry', fr: 'Choisir le ministère' },
  'orgchartSync.selectOrgchartPerson': { en: 'Select orgchart person', fr: 'Choisir la personne' },
  'orgchartSync.autoMatched': { en: 'Auto-matched', fr: 'Correspondance automatique' },
  'orgchartSync.selected': { en: 'selected', fr: 'sélectionné(s)' },
  'orgchartSync.confirmSelected': { en: 'Confirm selected', fr: 'Confirmer la sélection' },
  'orgchartSync.runSync': { en: 'Run Sync', fr: 'Lancer la synchronisation' },
  'orgchartSync.runSyncDescription': { en: 'Pull changes from the orgchart API and apply or queue them.', fr: 'Récupérer les changements de l\'organigramme et les appliquer ou les mettre en file d\'attente.' },
  'orgchartSync.availableAfterBackfill': { en: 'Available after backfill complete', fr: 'Disponible une fois le backfill terminé' },
  'orgchartSync.comingPhase2': { en: 'Coming in Phase 2', fr: 'Disponible en phase 2' },
  'orgchartSync.reviewQueue': { en: 'Review Queue', fr: 'File d\'attente' },
  'orgchartSync.reviewQueueDescription': { en: 'Destructive changes from orgchart wait here for admin approval.', fr: 'Les changements destructifs de l\'organigramme attendent ici l\'approbation de l\'administrateur.' },
  'orgchartSync.noChangesNeedReview': { en: 'No changes need review.', fr: 'Aucun changement à examiner.' },
  'orgchartSync.unlinkedBanner': { en: '{ministries} ministries and {people} people not yet linked to orgchart.', fr: '{ministries} ministères et {people} personnes ne sont pas encore liés à l\'organigramme.' },
  'orgchartSync.finishBackfill': { en: 'Finish backfill in Admin → Orgchart Sync.', fr: 'Terminer le rapprochement dans Admin → Synchro Organigramme.' },
  'orgchartSync.runSyncNow': { en: 'Run sync now', fr: 'Lancer la synchro' },
  'orgchartSync.runningSync': { en: 'Sync in progress…', fr: 'Synchronisation en cours…' },
  'orgchartSync.lastRun': { en: 'Last run', fr: 'Dernière exécution' },
  'orgchartSync.autoApplied': { en: 'auto-applied', fr: 'appliqué(s)' },
  'orgchartSync.queuedForReview': { en: 'queued for review', fr: 'à examiner' },
  'orgchartSync.errors': { en: 'error(s)', fr: 'erreur(s)' },
  'orgchartSync.changeMinistryDeleted': { en: 'Ministry deleted', fr: 'Ministère supprimé' },
  'orgchartSync.changePersonDeleted': { en: 'Person deleted', fr: 'Personne supprimée' },
  'orgchartSync.changeMinistryReparented': { en: 'Ministry reparented', fr: 'Ministère reparenté' },
  'orgchartSync.changeMembershipDropped': { en: 'Membership dropped', fr: 'Adhésion retirée' },
  'orgchartSync.colChangeType': { en: 'Change', fr: 'Changement' },
  'orgchartSync.colBefore': { en: 'Before', fr: 'Avant' },
  'orgchartSync.colAfter': { en: 'After', fr: 'Après' },
  'orgchartSync.colDetected': { en: 'Detected', fr: 'Détecté' },
  'orgchartSync.colActions': { en: 'Actions', fr: 'Actions' },
  'orgchartSync.apply': { en: 'Apply', fr: 'Appliquer' },
  'orgchartSync.dismiss': { en: 'Dismiss', fr: 'Ignorer' },
  'orgchartSync.snooze': { en: 'Snooze', fr: 'Reporter' },
  'orgchartSync.snoozed': { en: 'snoozed', fr: 'reporté' },
  'orgchartSync.showSnoozed': { en: 'Show snoozed', fr: 'Afficher reportés' },
  'orgchartSync.hideSnoozed': { en: 'Hide snoozed', fr: 'Masquer reportés' },
  ...
  // Navigation - Org Chart
  'nav.orgChart': { en: 'Org Chart', fr: 'Organigramme' },

  // Org Chart page
  'orgChart.title': { en: 'Organization Chart', fr: 'Organigramme' },
  'orgChart.subtitle': { en: 'Mont Carmel Church organizational structure', fr: 'Structure organisationnelle de l\'Église Mont Carmel' },
  'orgChart.totalPeople': { en: 'Total People', fr: 'Total Personnes' },
  'orgChart.ministries': { en: 'Ministries', fr: 'Ministères' },
  'orgChart.departments': { en: 'Departments', fr: 'Départements' },
  'orgChart.vacantPositions': { en: 'Vacant Positions', fr: 'Postes Vacants' },
  'orgChart.searchPlaceholder': { en: 'Search people, titles, departments...', fr: 'Rechercher personnes, titres, départements...' },
  'orgChart.filterLanguage': { en: 'Language', fr: 'Langue' },
  'orgChart.filterStatus': { en: 'Status', fr: 'Statut' },
  'orgChart.treeView': { en: 'Tree View', fr: 'Vue Arbre' },
  'orgChart.listView': { en: 'List View', fr: 'Vue Liste' },
  'orgChart.expandAll': { en: 'Expand All', fr: 'Tout Développer' },
  'orgChart.collapseAll': { en: 'Collapse All', fr: 'Tout Réduire' },
  'orgChart.allLanguages': { en: 'All Languages', fr: 'Toutes les Langues' },
  'orgChart.english': { en: 'English', fr: 'Anglais' },
  'orgChart.french': { en: 'French', fr: 'Français' },
  'orgChart.bilingual': { en: 'Bilingual', fr: 'Bilingue' },
  'orgChart.allStatuses': { en: 'All Statuses', fr: 'Tous les Statuts' },
  'orgChart.active': { en: 'Active', fr: 'Actif' },
  'orgChart.vacant': { en: 'Vacant', fr: 'Vacant' },
  'orgChart.position': { en: 'Position', fr: 'Poste' },
  'orgChart.reportsTo': { en: 'Reports to', fr: 'Rapporte à' },
  'orgChart.directReports': { en: 'Direct Reports', fr: 'Subordonnés Directs' },
  'orgChart.noReports': { en: 'No direct reports', fr: 'Aucun subordonné direct' },
  'orgChart.breadcrumb': { en: 'Position in hierarchy', fr: 'Position dans la hiérarchie' },
  'orgChart.contactInfo': { en: 'Contact Information', fr: 'Coordonnées' },
  'orgChart.viewProfile': { en: 'View Profile', fr: 'Voir le Profil' },
  'orgChart.noResults': { en: 'No results found', fr: 'Aucun résultat trouvé' },
  'orgChart.loading': { en: 'Loading org chart...', fr: 'Chargement de l\'organigramme...' },
  'orgChart.seniorLeadership': { en: 'Senior Leadership', fr: 'Direction Principale' },
  'orgChart.executiveLeadership': { en: 'Executive Leadership', fr: 'Direction Exécutive' },
  'orgChart.ministrySystem': { en: 'Ministry', fr: 'Ministère' },
  'orgChart.department': { en: 'Department', fr: 'Département' },
  'orgChart.program': { en: 'Program', fr: 'Programme' },
  'orgChart.team': { en: 'Team', fr: 'Équipe' },

  // Person profile - org position
  'personProfile.orgPosition': { en: 'Organization Position', fr: 'Position Organisationnelle' },
  'personProfile.position': { en: 'Position', fr: 'Poste' },
  'personProfile.ministry': { en: 'Ministry', fr: 'Ministère' },
  'personProfile.department': { en: 'Department', fr: 'Département' },
  'personProfile.directReports': { en: 'Direct Reports', fr: 'Subordonnés Directs' },
  'personProfile.bilingual': { en: 'Bilingual', fr: 'Bilingue' },

  // Ministries - live stats
  'ministries.totalPeople': { en: 'People', fr: 'Personnes' },
  'ministries.totalDepartments': { en: 'Departments', fr: 'Départements' },
  'ministries.activeDepartments': { en: 'Active Depts', fr: 'Dép. Actifs' },
  'ministries.people': { en: 'people', fr: 'personnes' },
  'ministries.noLeader': { en: 'No leader assigned', fr: 'Aucun responsable assigné' },
  'ministries.leaderAssigned': { en: 'Leader assigned', fr: 'Responsable assigné' },
};
