...
export default function People() {
  ...
  const tabValues = ['directory', 'org-chart', ...(isSupervisor ? ['my-team'] : []), 'peers', 'supervisor'] as const;
      ...
      <PullToRefresh onRefresh={handleRefresh} className="min-h-[calc(100vh-12rem)]">
        <div className="space-y-4 md:space-y-6 animate-fade-in">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-4 sm:grid-cols-5 sm:w-auto sm:inline-flex">
